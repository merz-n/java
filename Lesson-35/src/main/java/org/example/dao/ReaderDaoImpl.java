...
public class ReaderDaoImpl implements ReaderDao {
    ...
    @Override
    public boolean addReader(Reader readerToSave) {
        ...
        try (Connection conn = Database.getConnection();
            ...
            stmt.setString(1, readerToSave.getName());
            stmt.setString(2, readerToSave.getEmail());
            stmt.setString(3, readerToSave.getPhone());
