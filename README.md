...
ФИО: Анастасия Мерц
Род занятий: На данный момент учу язык(немецкий и английский), ищу работу в германии в сфере ит. Занимаюсь разработкой сайтов на Wordpress. 
...
OC: Windows
Проект: "Умный Task Manager"(система управления задачами +AI помощник) - проект на Spring Boot с микросервисной архитектурой.
